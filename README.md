...
## [Frontend](https://github.com/RomanKosmyna/venue-app)
## [Backend](https://github.com/RomanKosmyna/venue-app-backend)

Main Technologies:
HTML5, CSS, TypeScript, React, Next.js, C#, ASP .NET Core, ASP .NET Core Web API, MS SQL Server, Entity Framework
